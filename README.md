...
Обновлённое развёртывание с автоматической проверкой балансировки и IAM-токеном
в памяти также проверено оператором на Windows. Последующее удаление стенда
прошло успешно по подтверждению оператора; отдельные журналы не приложены.
...
Для нового стенда выполнить подготовку ниже, затем следовать инструкции своей ОС.
...
не подтверждают работоспособность приложения. Развёртывание и последующее
удаление с Windows подтверждены оператором. Полный цикл с Linux-рабочего
места пока не проверен.
